...
public class Scan implements GlobalConst {
    ...
    public Tuple getNextTuple(MID mid)
        ...
        userrid = datapage.nextRecord(mid);
    ...
    public Map getNextMap(MID mid)
        ...
        try {
            recptrmap = datapage.getMapRecord(mid);
        } catch (Exception e) {
            //    System.err.println("SCAN: Error in Scan" + e);
            e.printStackTrace();
        }
     ...
     *			false otherwise.
     */
    public boolean positionTuple(MID mid)
            throws InvalidTupleSizeException,
            IOException {
        MID nxtrid = new MID();
        boolean bst;
        ...
        if (!datapageId.equals(pgid)) {
            ...
            bst = firstDataPageTuple();

            if (bst != true)
                return bst;

            while (!datapageId.equals(pgid)) {
                bst = nextDataPageTuple();
                if (bst != true)
                    return bst;
            }
        }
     ...
     *			false otherwise.
     */
    public boolean positionMap(MID mid)
            throws InvalidTupleSizeException,
            IOException {
        MID nxtrid = new MID();
        boolean bst;
     ...
     *         false otherwise
     */
    private boolean firstDataPageTuple()
            throws InvalidTupleSizeException,
            IOException {
        DataPageInfo dpinfo;
        Tuple rectuple = null;
     ...
     *         false otherwise
     */
    private boolean firstDataPageMap()
            throws InvalidTupleSizeException,
            IOException {
        DataPageInfo dpinfo;
        Map recmap = null;
     ...
     */
    private boolean nextDataPageTuple()
            throws InvalidTupleSizeException,
            IOException {
        DataPageInfo dpinfo;
     ...
     *			false if unsuccessful
     */
    private boolean nextDataPageMap()
            throws InvalidTupleSizeException,
            IOException {
        DataPageInfo dpinfo;
     ...
     */
    private boolean mvNextTuple(MID mid)
            throws InvalidTupleSizeException,
            IOException {
        MID nextrid;
        boolean status;
     ...
     * Also returns the MID of the (new) current record.
     */
    private boolean mvNextMap(MID mid)
            throws InvalidTupleSizeException,
            IOException {
        MID nextrid;
        boolean status;
