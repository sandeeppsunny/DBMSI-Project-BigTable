...
public class Scan implements GlobalConst {
     ...
     */
    public Tuple getNextTuple(RID rid)
            throws InvalidTupleSizeException,
            IOException {
     ...
     *			false otherwise.
     */
    public boolean positionTuple(RID rid)
            throws InvalidTupleSizeException,
            IOException {
        RID nxtrid = new RID();
        boolean bst;
     ...
     *			false otherwise.
     */
    public boolean positionMap(RID rid)
            throws InvalidTupleSizeException,
            IOException {
        RID nxtrid = new RID();
        boolean bst;
     ...
     */
    private boolean mvNextTuple(RID rid)
            throws InvalidTupleSizeException,
            IOException {
        RID nextrid;
        boolean status;
     ...
     * Also returns the RID of the (new) current record.
     */
    private boolean mvNextMap(RID rid)
            throws InvalidTupleSizeException,
            IOException {
        RID nextrid;
        boolean status;
