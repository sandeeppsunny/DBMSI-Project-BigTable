...
public class bigt {
    ...
    public void createIndex() throws GetFileEntryException, ConstructPageException, IOException, AddFileEntryException {
        switch (type) {
            case 1:
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                index1 = new BTreeFile("Index1", AttrType.attrString, 80, DeleteFashion.NAIVE_DELETE);
